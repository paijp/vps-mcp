 ...
 *
 * Environment variables (from /etc/vps-mcp/host.env):
...
mcp.tool(
  "exec_command",
  "Execute a shell command on the VPS. Returns stdout and stderr. If this VPS is a primary DNS server, notify may take more than 10 minutes.",
